...
public class Rational implements Comparable<Rational>,DoubleValue
{
 ...
 //-----------------------------------------------------------------
   //  Adds this two paramater rationals together.
   //  A common denominator is found by multiplying the individual
   //  denominators.
   //-----------------------------------------------------------------
 ...
 //-----------------------------------------------------------------
   ...
   {
      return Rational.multiply(op1, op2.reciprocal());
   }
   public boolean equals(Rational op1, Rational op2) {
	   if(op1.getNumerator() == op2.getNumerator() && op1.getDenominator() == op2.getDenominator()) {
		   return true;
	   }
	   else {
		   return false;
   ...
   public int compareTo(Rational op1) {
	  double temp = (Rational.subtract(this, op1).toDouble());
	  if (temp != 0) {
		  if((int)temp != 0) {
			  return (int)temp;
		  }
